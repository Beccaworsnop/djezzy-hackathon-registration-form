...
const RegistrationForm = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black to-rose-900 text-white p-6">
        ...
        <div className="relative mb-8">
          <div className="flex justify-between items-center mb-2">
            {[1, 2, 3].map((num) => (
              <span
                key={num}
                className={`text-2xl font-bold ${step >= num ? 'text-rose-500' : 'text-gray-400'}`}
              >
                {num}
              </span>
            ))}
          </div>
          <div className="w-full bg-gray-700 rounded-full border-1 border-white-500 h-3">
            <div
              className="bg-rose-900 h-2 rounded-full transition-all duration-300"
            ...
            <>
              <div>
                <input
                  ...
                  className="p-3 bg-gray-800 border-1 border-red-900 rounded w-full"
                />
...
{step === 2 && (
  <>
    ...
    <div className="col-span-2">
      <div className="p-3 bg-gray-800 border-1 border-red-900 rounded w-full">
        ...
        <div className="flex justify-between mt-6">
          {step > 1 && (
            <button onClick={prevStep} className="bg-rose-900 px-6 py-2 border-2 border-white-500 rounded-lg">
              BACK
            </button>
          )}
          {step < 3 && (
            <button onClick={validateStep} className="bg-rose-900 px-6 py-2 border-2 border-white-500 rounded-lg ">
              NEXT
            </button>
          )}
          {step === 3 && (
            <button
              ...
              className="bg-rose-900 px-6 py-2 border-2 border-white-500 rounded-lg"
            >
              SUBMIT
            </button>
          )}
